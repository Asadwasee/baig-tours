// components/package-details/HighlightsSection.tsx
import {
  CheckCircle2,
  XCircle,
  Mountain,
...
export default function HighlightsSection({ packageData }: HighlightsSectionProps) {
  ...
  const included = packageData.includedServices || [
    "Luxury Transport",
  ...
  const excluded = packageData.excludedServices || [
    "Lunch",
    "Personal Shopping",
    "Laundry",
    "Travel Insurance",
      ...
      <div className="container-custom">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-5 leading-8 text-gray-600">
            Experience the very best of {packageData.destination} through breathtaking landscapes,
          ...
          <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Everything covered in your package</p>
              </div>
            </div>
            <div className="space-y-4">
              {included.map((item: string) => (
                <div key={item} className="flex items-center justify-between rounded-xl bg-[#F8FAFC] px-5 py-4">
          ...
          <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Expenses not covered in this package</p>
              </div>
            </div>
            <div className="space-y-4">
